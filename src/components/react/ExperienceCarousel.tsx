    ...
    items: [
      {
        ...
        key: 'Successfully lead small team of specialists though a major upgrade (7.6.x -> MAS 9.1), infrastructure change (WebSphere -> RedHat OpenShift), and cloud migration simultaneously - in a little over 6 months. Securely integrated multiple on-prem legacy systems via Denodo middleware.',
      },
      {
        ...
        key: 'Developed multiple custom regulatory applications in Maximo/Manage, Maximo Mobile, and EZMaxMobile • Automated staff scheduling, increasing efficiency by 80-90% • Optimized licensing for staff leading to > 1.2 million in savings • Successfully integrated ERP, GIS, SCADA, and multiple other proprietary systems.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        current: true,
        icon: 'lucide:code',
        key: 'Developed multiple Java enterprise web applications currently in use department wide • Spearheaded implementation of modern CI/CD pipelines in Azure DevOps - reducing deployment time by 80% • Setup performance monitoring infrastructure using Prometheus and Grafana',
      },
      {
        ...
        period: '2017 - 2019',
        icon: 'lucide:layers',
        key: 'Developed multiple public-facing digital solutions leveraging Power Platform, IBM WebSphere and other misc. web technologies • Responsible for everything from documentation and development to stakeholder management, training and support'
      },
      {
        role: 'Independent Consulting',
        company: 'Various (Game Used Only, High Speed Hockey, etc.)',
        period: '2015 - 2025',
        icon: 'lucide:terminal',
        key: 'Developed and maintained multiple custom React web apps and Visual Basic desktop applications • Leveraged Cloudflare to secure multiple domains, enable user authentication and boost TTFB by 70% +',
      },
    ],
  },
  {
